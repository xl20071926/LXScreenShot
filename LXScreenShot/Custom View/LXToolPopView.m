...
@property (nonatomic, strong) LXColorSelectView *colorSelectView;
...
- (void)addSubViews {
    ...
    self.colorSelectView.completeBlock = ^(UIColor *color) {
        [weakSelf.colorButton setImage:[UIImage imageWithColor:color size:weakSelf.colorButton.size] forState:UIControlStateNormal];
    };
    self.hidden = YES;
}
...
- (void)onColorButtonClick:(UIButton *)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(toolPopView:clickedColorButtonWithColor:)]) {
        [self.delegate toolPopView:self clickedColorButtonWithColor:nil];
    }
}
...
- (UIButton *)smallSizeButton {
    ...
    if (!_smallSizeButton) {
        ...
        _smallSizeButton.tag = PopViewSizeButtonTagSmall;
...
- (UIButton *)midSizeButton {
    ...
    if (!_midSizeButton) {
        ...
        _midSizeButton.tag = PopViewSizeButtonTagMid;
...
- (UIButton *)bigSizeButton {
    ...
    if (!_bigSizeButton) {
        ...
        _bigSizeButton.tag = PopViewSizeButtonTagBig;
